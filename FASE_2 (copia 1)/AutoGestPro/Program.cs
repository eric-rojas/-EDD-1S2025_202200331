...
namespace AutoGestPro
{
    class Program
    {
        ...
        static void Main()
        {
            ...
            InicializarDatos();
            // Agregar servicios predeterminados en orden aleatorio
            arbolServicios.Insertar(new Servicio(15, 3, 1, "Cambio de pastillas de freno", 750));
            arbolServicios.Insertar(new Servicio(7, 2, 1, "Afinación menor", 350));
            arbolServicios.Insertar(new Servicio(23, 1, 1, "Cambio de amortiguadores", 1150));
            arbolServicios.Insertar(new Servicio(4, 4, 1, "Alineación y balanceo", 200));
            arbolServicios.Insertar(new Servicio(19, 2, 1, "Cambio de batería", 950));
            arbolServicios.Insertar(new Servicio(11, 3, 1, "Reparación de alternador", 550));
            arbolServicios.Insertar(new Servicio(25, 4, 1, "Reparación de motor", 1250));
            arbolServicios.Insertar(new Servicio(2, 1, 1, "Cambio de aceite", 100));
            arbolServicios.Insertar(new Servicio(16, 2, 1, "Cambio de clutch", 800));
            arbolServicios.Insertar(new Servicio(9, 3, 1, "Servicio de aire acondicionado", 450));
            arbolServicios.Insertar(new Servicio(21, 4, 1, "Reparación de transmisión", 1050));
            arbolServicios.Insertar(new Servicio(13, 1, 1, "Cambio de radiador", 650));
            arbolServicios.Insertar(new Servicio(6, 2, 1, "Cambio de bujías", 300));
            arbolServicios.Insertar(new Servicio(24, 3, 1, "Reparación sistema eléctrico", 1200));
            arbolServicios.Insertar(new Servicio(1, 4, 1, "Revisión general", 50));
